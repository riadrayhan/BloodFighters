...
class Active_Donor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection('test')
          .where('Inactive', isEqualTo: 'Active') // Replace with your field and filter value
          .snapshots(),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(3.0),
                                      child: Text('active',style: TextStyle(fontWeight: FontWeight.normal,color: Colors.green)),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.all(3.0),
